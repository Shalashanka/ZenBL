...
import com.zentox.engine.AppDatabase
import com.zentox.engine.BlockedApp
import com.zentox.engine.ZenSchedule
import com.zentox.engine.ZenStatus
import com.zentox.engine.ZentoxAlarmManager
import com.zentox.engine.ZentoxManager
import com.zentox.engine.ZentoxState
...
class ZentoxBridgeModule(
    ...
    init {
        ZentoxState.initialize(reactApplicationContext)
        ZentoxManager.initialize(reactApplicationContext, blockedAppDao)
    }
    ...
    fun startZen(duration: Int) {
        ...
        ZentoxManager.startZen(duration.toLong(), "MANUAL")
        emitStatusChanged()
    }
    ...
    fun triggerManualZen(durationSec: Int, isFortress: Boolean) {
        ...
        ZentoxManager.startZen(durationMs, "MANUAL")
        emitStatusChanged()
    }
    ...
    fun deleteSchedule(id: Double, promise: Promise) {
        bridgeScope.launch {
            try {
                ...
                ZentoxAlarmManager().cancelAlarm(reactApplicationContext, scheduleId)
    ...
    private fun emitStatusChanged() {
        ...
        reactApplicationContext
            ...
            .emit("ZentoxStatusChanged", payload)
    }

    companion object {
        const val MODULE_NAME = "ZentoxBridge"
        private const val TAG = "ZentoxBridgeModule"
    }
    ...
    private fun isAccessibilityServiceEnabled(): Boolean {
        ...
        val expected = "${reactApplicationContext.packageName}/${com.zentox.engine.ZentoxAccessibilityService::class.java.name}"
